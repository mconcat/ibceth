...
import (
	...
	appparams "github.com/mconcat/ibc-eth/app/params"
	"github.com/mconcat/ibc-eth/x/ibceth"
	ibcethkeeper "github.com/mconcat/ibc-eth/x/ibceth/keeper"
	ibcethtypes "github.com/mconcat/ibc-eth/x/ibceth/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/ibcethd")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	ibcethKeeper ibcethkeeper.Keeper
...
func New(
	...
	app.ibcethKeeper = *ibcethkeeper.NewKeeper(
        appCodec, keys[ibcethtypes.StoreKey], keys[ibcethtypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		ibceth.NewAppModule(appCodec, app.ibcethKeeper),
